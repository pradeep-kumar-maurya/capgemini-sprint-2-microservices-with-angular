...
public class Payments {
	...
	public String toString() {
		return "Payments [booking_id=" + booking_id + ", account_no=" + account_no + ", money_collected="
				+ money_collected + ", seats_booked=" + seats_booked + ", seat_type=" + seat_type + ", refund=" + refund
				+ ", date_of_transac=" + date_of_transac + "]";
	}
